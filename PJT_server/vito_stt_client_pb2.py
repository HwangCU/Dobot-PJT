...
_DECODERREQUEST = DESCRIPTOR.message_types_by_name['DecoderRequest']
_DECODERRESPONSE = DESCRIPTOR.message_types_by_name['DecoderResponse']
...
_DECODERCONFIG = DESCRIPTOR.message_types_by_name['DecoderConfig']
_RUNTIMESTREAMCONFIG = DESCRIPTOR.message_types_by_name['RuntimeStreamConfig']
_DECODERRESPONSE_SPEECHEVENTTYPE = _DECODERRESPONSE.enum_types_by_name['SpeechEventType']
_DECODERCONFIG_AUDIOENCODING = _DECODERCONFIG.enum_types_by_name['AudioEncoding']
DecoderRequest = _reflection.GeneratedProtocolMessageType('DecoderRequest', (_message.Message,), {
  'DESCRIPTOR' : _DECODERREQUEST,
  '__module__' : 'vito_stt_client_pb2'
  # @@protoc_insertion_point(class_scope:online_decoder.DecoderRequest)
  })
_sym_db.RegisterMessage(DecoderRequest)

DecoderResponse = _reflection.GeneratedProtocolMessageType('DecoderResponse', (_message.Message,), {
  'DESCRIPTOR' : _DECODERRESPONSE,
  '__module__' : 'vito_stt_client_pb2'
  # @@protoc_insertion_point(class_scope:online_decoder.DecoderResponse)
  })
_sym_db.RegisterMessage(DecoderResponse)
...
StreamingRecognitionResult = _reflection.GeneratedProtocolMessageType('StreamingRecognitionResult', (_message.Message,), {
  ...
  '__module__' : 'vito_stt_client_pb2'
  # @@protoc_insertion_point(class_scope:online_decoder.StreamingRecognitionResult)
  })
...
SpeechRecognitionAlternative = _reflection.GeneratedProtocolMessageType('SpeechRecognitionAlternative', (_message.Message,), {
  ...
  '__module__' : 'vito_stt_client_pb2'
  # @@protoc_insertion_point(class_scope:online_decoder.SpeechRecognitionAlternative)
  })
...
WordInfo = _reflection.GeneratedProtocolMessageType('WordInfo', (_message.Message,), {
  ...
  '__module__' : 'vito_stt_client_pb2'
  # @@protoc_insertion_point(class_scope:online_decoder.WordInfo)
  })
...
DecoderConfig = _reflection.GeneratedProtocolMessageType('DecoderConfig', (_message.Message,), {
  ...
  '__module__' : 'vito_stt_client_pb2'
  # @@protoc_insertion_point(class_scope:online_decoder.DecoderConfig)
  })
_sym_db.RegisterMessage(DecoderConfig)

RuntimeStreamConfig = _reflection.GeneratedProtocolMessageType('RuntimeStreamConfig', (_message.Message,), {
  'DESCRIPTOR' : _RUNTIMESTREAMCONFIG,
  '__module__' : 'vito_stt_client_pb2'
  # @@protoc_insertion_point(class_scope:online_decoder.RuntimeStreamConfig)
  })
_sym_db.RegisterMessage(RuntimeStreamConfig)

_ONLINEDECODER = DESCRIPTOR.services_by_name['OnlineDecoder']
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _DECODERCONFIG._serialized_end=1370
  _DECODERCONFIG_AUDIOENCODING._serialized_start=1134
  _DECODERCONFIG_AUDIOENCODING._serialized_end=1274
  _RUNTIMESTREAMCONFIG._serialized_start=1372
  _RUNTIMESTREAMCONFIG._serialized_end=1485
  _ONLINEDECODER._serialized_start=1487
  _ONLINEDECODER._serialized_end=1583
